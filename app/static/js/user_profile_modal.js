                            ...
                            ${data.riding_preferences_choices.map((choice,i)=>`
                              <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox"
                                       id="ridingPref-${i}" name="riding_preferences" value="${choice[0]}"
                    ...
                    <form id="editBikeForm" class="needs-validation" novalidate>
                      ...
                      ${data.user.bike_picture?`
                        <div class="form-group mb-3">
                          ...
                          <img src="/static/${data.user.bike_picture}" class="img-fluid rounded shadow-sm">
                        </div>`:``}
                      <div class="form-group mb-3">
                    ...
                    ${data.user.badges && data.user.badges.length
                      ? data.user.badges.map(badge => `
                        <div class="badge-card">
                          <img src="/static/images/badge_images/${badge.image}"
                               alt="${badge.name}"
                               class="badge-icon" style="width: 100px">
                    ...
                    ${data.quest_submissions && data.quest_submissions.length
                      ? data.quest_submissions.map(sub => `
                        <div class="submission-item col-md-6 p-3 border rounded shadow-sm bg-white">
                          ${sub.image_url?`<img src="${sub.image_url}" class="img-fluid rounded mb-2" style="max-height:200px;object-fit:cover;">`:``}
        ...
        .map(message => {
            ...
            const canReply = (depth < 2) &&
                             (currentUserId === profileUserId ||
                              ...
                              (message.parent_id &&
                               currentUserId === messages.find(m => m.id === message.parent_id).author_id));
